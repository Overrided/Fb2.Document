...
namespace Fb2.Document.Tests.ModelsTests
{
    public class Fb2NodeTests
    {
        ...
        {
            if (instance.AllowedAttributes == null || instance.AllowedAttributes.Count == 0)
                return;
        ...
        public void AddAttribute_EmptyOrNull_Throws(Fb2Node instance)
        {
            ...
            instance
                .Invoking(i => i.AddAttributes(new List<Fb2Attribute>()))
                .Should()
                .ThrowExactly<ArgumentNullException>();

            instance
                .Invoking(i => i.AddAttributes(Enumerable.Empty<Fb2Attribute>()))
                .Should()
                .ThrowExactly<ArgumentNullException>();
